 ...
 */
package mod.gottsch.neoforge.everfurnace.farmersdelight.core.cooking;

import mod.gottsch.neoforge.everfurnace.farmersdelight.core.mixin.StoveBlockEntityMixin;

/**
 * Plain interface exposing the {@code @Unique} timing field injected into
 * {@code AbstractStoveBlockEntity} by {@link StoveBlockEntityMixin}.
 *
 ...
 *   long last = stove.everfurnacefd$getLastGameTime();
 * }</pre>
 *
 * @author Mark Gottschling
 */
public interface IEverFurnaceFDStove {
