 ...
 */
package mod.gottsch.neoforge.everfurnace.farmersdelight.core.config;

import net.neoforged.neoforge.common.ModConfigSpec;
import org.apache.commons.lang3.tuple.Pair;

/**
 * NeoForge configuration for EverFurnace: Farmer's Delight.
 *
 * <p>A single {@link Client} spec, stored in
 * {@code config/everfurnace_farmersdelight-client.toml}. Catch-up behaviour itself
...
public final class EverFurnaceFDConfig {
    ...
    public static final class Client {
         ...
         */
        public final ModConfigSpec.BooleanValue catchupMessageEnabled;
